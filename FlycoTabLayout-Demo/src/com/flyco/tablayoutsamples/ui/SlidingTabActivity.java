...
@SuppressLint("NewApi")
public class SlidingTabActivity extends AppCompatActivity implements
		OnTabSelectListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/** indicator圆角色块 */
		SlidingTabLayout tabLayout_10 = ViewFindUtils.find(decorView,
				R.id.tl_10);
	...
	public void onTabSelect(int position) {
		Toast.makeText(mContext, "onTabSelect&position--->" + position,
				Toast.LENGTH_SHORT).show();
	}

	@Override
	public void onTabReselect(int position) {
		Toast.makeText(mContext, "onTabReselect&position--->" + position,
				Toast.LENGTH_SHORT).show();
	}
